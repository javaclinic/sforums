...
public class UserAndPasswordProfileFormController {
    ...
    private static final Logger logger = LoggerFactory.getLogger(UserAndPasswordProfileFormController.class);

    private final UserContextService userContextService;
    private final UserStoreService userStoreService;

    @Autowired
    public UserAndPasswordProfileFormController(UserContextService userContextService, UserStoreService userStoreService) {
                ...
                SessionStatus status)
    {
        if (!result.hasErrors()) {
            try {
                ...
                result.reject("ConcurrentModificationFailure");
            }
        }
        return "userForm";
    }
